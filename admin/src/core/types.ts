...
export type AdnminGetMeQueryVariables = Exact<{ [key: string]: never; }>;


export type AdnminGetMeQuery = { __typename?: 'query_root', adminGetMe?: { __typename?: 'AdminGetMeOutput', username: string, id: string } | null };
...
export const AdnminGetMeDocument = gql`
    query AdnminGetMe {
  adminGetMe {
    username
    id
...
/**
 * __useAdnminGetMeQuery__
 *
 * To run a query within a React component, call `useAdnminGetMeQuery` and pass it any options that fit your needs.
 * When your component renders, `useAdnminGetMeQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAdnminGetMeQuery({
 *   variables: {
 *   },
 * });
 */
export function useAdnminGetMeQuery(baseOptions?: Apollo.QueryHookOptions<AdnminGetMeQuery, AdnminGetMeQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AdnminGetMeQuery, AdnminGetMeQueryVariables>(AdnminGetMeDocument, options);
      }
export function useAdnminGetMeLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AdnminGetMeQuery, AdnminGetMeQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AdnminGetMeQuery, AdnminGetMeQueryVariables>(AdnminGetMeDocument, options);
        }
export type AdnminGetMeQueryHookResult = ReturnType<typeof useAdnminGetMeQuery>;
export type AdnminGetMeLazyQueryHookResult = ReturnType<typeof useAdnminGetMeLazyQuery>;
export type AdnminGetMeQueryResult = Apollo.QueryResult<AdnminGetMeQuery, AdnminGetMeQueryVariables>;
export const AdminLoginDocument = gql`
    query AdminLogin($password: String!, $username: String!) {
  adminLogin(args: {password: $password, username: $username}) {
    accessToken
  }
}
    `;
